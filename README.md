...
A GitHub Action to automatically bump and tag main, on merge, with the latest SemVer formatted version. Works on any platform.
  ...
  build:
    ...
    steps:
      ...
      - name: Bump version and push tag
        id: tag_version
        uses: signalscode/github-tag-action@v7.0.3
        with:
